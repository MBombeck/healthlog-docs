...
export default defineConfig({
	...
	redirects: {
		...
		'/integrations/data-import/': '/guides/import-csv/',
			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ slug: 'guides/labs' },
						{ slug: 'guides/vaccinations' },
						{ slug: 'guides/illness' },
						{ slug: 'guides/cycle-tracking' },
						{ slug: 'guides/custom-metrics' },
						{ slug: 'guides/checkups-and-practitioners' },
